    ...
    return (
        <div>
            ...
            <div onClick={() => {
                ...
                <h2 className='text-lg font-semibold'>C${props.fare.car}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
                ...
                <h2 className='text-lg font-semibold'>C${props.fare.moto}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
                ...
                <h2 className='text-lg font-semibold'>C${props.fare.auto}</h2>
            </div>
        </div>
    )
}
